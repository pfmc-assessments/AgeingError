...
The examples in this Vignette have input files that were already developed.
For information on creating new input files, the new functions `create_data_file()`
and `create_specs_file()` can help. See the reference for those functions for 
more detail.
...
The `create_data_file()` function makes it easier to create a file which matches
the required format.
